...
curl -d "Instance=$(< /root/instnum.txt)&Log=Booting VSI" -X POST https://daitest.leibcorp.com/log

mkdir /root/demo
mkdir /root/da
wget -O /root/logosmall.png https://daitest.leibcorp.com/$(< /root/companycompact.txt).small.png
...
apt-get update
curl -d "Instance=$(< /root/instnum.txt)&Log=Patching VSI" -X POST https://daitest.leibcorp.com/log
apt-get -y -o Dpkg::Options::="--force-confnew" upgrade
curl -d "i=$(< /root/instnum.txt)&Log=Installing Core Packages" -X POST https://daitest.leibcorp.com/log
...
curl -d "Instance=$(< /root/instnum.txt)&Log=Installing postgreSQL" -X POST https://daitest.leibcorp.com/log
...
curl -d "Instance=$(< /root/instnum.txt)&Log=Installing Node" -X POST https://daitest.leibcorp.com/log
...
curl -d "Instance=$(< /root/instnum.txt)&Log=Starting Data Aggregator" -X POST https://daitest.leibcorp.com/log
