...
declare class DiscoveryV2 extends BaseService {
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.TrainingQuerySet>>}
     */
    listCurations(params: DiscoveryV2.ListCurationsParams): Promise<DiscoveryV2.Response<DiscoveryV2.TrainingQuerySet>>;
    /**
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.Empty>>}
     */
    deleteCuration(params: DiscoveryV2.DeleteCurationParams): Promise<DiscoveryV2.Response<DiscoveryV2.Empty>>;
    /**
     * Delete training queries.
     *
     * Removes all training queries for the specified project.
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.TrainingQuery>>}
     */
     createCuration(params: DiscoveryV2.CreateCurationParams): Promise<DiscoveryV2.Response<DiscoveryV2.TrainingQuery>>;
    /**
     * Get a training data query.
     *
     * Get details for a specific training data query, including the query string and all examples.
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.TrainingQuery>>}
     */
    updateCuration(params: DiscoveryV2.UpdateCurationParams): Promise<DiscoveryV2.Response<DiscoveryV2.TrainingQuery>>;
    /*************************
     * analyze
     ************************/
    /**
...
declare namespace DiscoveryV2 {
    ...
    /** Parameters for the `listCurations` operation. */
    interface ListCurationsParams {
        /** The ID of the project. This information can be found from the deploy page of the Discovery administrative
         *  tooling.
         */
        projectId: string;
    ...
    /** Parameters for the `deleteTrainingQueries` operation. */
    interface DeleteCurationParams {
        /** The ID of the project. This information can be found from the deploy page of the Discovery administrative
         *  tooling.
         */
        projectId: string;
    ...
    /** Parameters for the `createCuration` operation. */
    interface CreateCurationParams {
        /** The ID of the project. This information can be found from the deploy page of the Discovery administrative
         *  tooling.
         */
        projectId: string;
        ...
        naturalLanguageQuery: string;
        /** Array of training examples. */
        curated_results: CurationExample[];
        headers?: OutgoingHttpHeaders;
    }
